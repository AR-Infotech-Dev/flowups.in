...
export const servicesData = [  
  {
    ...
    description:
      "Custom TDL modules, Tally Prime enhancements, reporting tools, voucher controls, invoice formats, security modules, and API integrations designed for your business process.",
    img: "services-1.jpg",
    points: [
      "Inventory tracking",
      "Product lifecycle",
