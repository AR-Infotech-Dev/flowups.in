                      ...
                      <div className="row g-4">
                        {group.services.map((item) => (
                          <div className="col-lg-4 col-md-6 " key={item.slug}>
                            ...
                            >
                              <div className="card border-0 shadow-sm h-100 module-card " style={{
                                borderRadius: "5px",
                                cursor: "pointer", paddingBottom: "15px"
                              }}>
                                <div style={{ alignItems: "center", padding: "7px" }}>
                                  <i className={`bi ${item.icon || "bi-grid"}`} style={{
                                    fontSize: "26px", color: "var(--accent-color)"
                                    , marginRight: "15px", marginLeft: "15px"
                                  }}></i>

                                  < h5 style={{ lineHeight: "1.5", paddingLeft: "15px", fontWeight: "600", }}>{item.name}</h5>
